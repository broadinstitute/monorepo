Monorepo of the Carpenter-Singh Lab, hosting many of the tools and methods we develop and use.
...
- [copairs_runner](https://github.com/broadinstitute/monorepo/tree/main/libs/copairs_runner): Configurable runner for copairs analyses.
