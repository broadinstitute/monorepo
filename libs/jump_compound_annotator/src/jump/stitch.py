...
from jump.utils import load_jump_ids
...
keys = pd.read_csv(output_path / 'stitch/chemicals.inchikeys.v5.0.tsv.gz',
                   sep='\t')
...
jump_links = jump_links.merge(keys,
                              left_on='chemical',
                              right_on='flat_chemical_id')
annotations = jump_links.pivot_table(index='inchikey',
                                     columns='HGNC symbol',
